...
public final class ActivityListBinding implements ViewBinding {
  ...
  private ActivityListBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton btnHome,
      @NonNull Button btnWrite, @NonNull TextView emptyMessageTextView,
      @NonNull ConstraintLayout main, @NonNull RecyclerView txtList, @NonNull TextView txtTitle) {
  ...
  public static ActivityListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityListBinding((ConstraintLayout) rootView, btnHome, btnWrite,
